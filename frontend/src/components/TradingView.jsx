...
// The Trading tab: Workspace (file tree of searches + the embedded trade site), Regex (the
// in-game search-string builder), Live (pings + one-click travel-to-hideout) and Sales. The
// trade site lives INSIDE the workspace — no separate Browse tab.
const SUBS = [
